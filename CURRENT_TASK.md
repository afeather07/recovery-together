...
Code is pushed to GitHub. Nothing is deployed yet.

## Next task
See "Blocking launch" in `FOUNDER_ACTION_ITEMS.md`. In order: Supabase project + schema, then Vercel connection + env vars, then a full click-through test on a phone-sized viewport, then launch.
